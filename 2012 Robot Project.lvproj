...
<Project Type="Project" LVVersion="11008008">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.20.79.2</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="toggleAutoDrive.vi" Type="VI" URL="../toggleAutoDrive.vi"/>
			<Item Name="User msg.vi" Type="VI" URL="../User msg.vi"/>
			<Item Name="Calculate distance from sonar reading.vi" Type="VI" URL="../Calculate distance from sonar reading.vi"/>
			<Item Name="drive straight - dad cop 2.vi" Type="VI" URL="../drive straight - dad cop 2.vi"/>
			<Item Name="drive straight.vi" Type="VI" URL="../drive straight.vi"/>
			<Item Name="encoder task.vi" Type="VI" URL="../encoder task.vi"/>
			<Item Name="Gyro Begin.vi" Type="VI" URL="../Gyro Begin.vi"/>
			<Item Name="Gyro Task.vi" Type="VI" URL="../Gyro Task.vi"/>
			<Item Name="limitswitchcontroll.vi" Type="VI" URL="../limitswitchcontroll.vi"/>
			<Item Name="Moving Avg.vi" Type="VI" URL="../Moving Avg.vi"/>
			<Item Name="NewDrive.vi" Type="VI" URL="../NewDrive.vi"/>
			<Item Name="Ramp.vi" Type="VI" URL="../Ramp.vi"/>
			<Item Name="RampDrive.vi" Type="VI" URL="../RampDrive.vi"/>
			<Item Name="Set Angle Speed.vi" Type="VI" URL="../Set Angle Speed.vi"/>
			<Item Name="Set Collector Speed.vi" Type="VI" URL="../Set Collector Speed.vi"/>
			<Item Name="Set Elevator Speed.vi" Type="VI" URL="../Set Elevator Speed.vi"/>
			<Item Name="Set Hammer Speed.vi" Type="VI" URL="../Set Hammer Speed.vi"/>
			<Item Name="Set Moter Speed.vi" Type="VI" URL="../Set Moter Speed.vi"/>
			<Item Name="Set Shooter Speed.vi" Type="VI" URL="../Set Shooter Speed.vi"/>
			<Item Name="sonar task.vi" Type="VI" URL="../sonar task.vi"/>
			<Item Name="switch task.vi" Type="VI" URL="../switch task.vi"/>
			<Item Name="teleop drive straight.vi" Type="VI" URL="../teleop drive straight.vi"/>
			<Item Name="test moving avg.vi" Type="VI" URL="../test moving avg.vi"/>
			<Item Name="EdgeDetector.vi" Type="VI" URL="../EdgeDetector.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Users/ALARM/Documents/Repos/auto update/Builds</Property>
